    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-800 to-primary-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-xl font-bold text-gray-800">TSHF Admin Panel</h1>
          <p className="text-sm text-gray-500 mt-1">Yönetim sistemine giriş yapın</p>
        </div>
