...
export const metadata = { title: 'Disiplin Kurulu' }

export default async function DisiplinPage() {
  const members = await prisma.boardMember.findMany({
    where: { board: 'disiplin' },
    orderBy: { order: 'asc' },
  })

  return (
    <div className="max-w-5xl mx-auto px-4 py-8 sm:py-12">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-8 sm:mb-10">Disiplin Kurulu</h1>
